...
namespace DotDll.Tests.Presentation.ViewModel
{
    ...
    public class MenuViewModelTest
    {
        ...
        private readonly string _pickedPath = "picked/path";
        ...
        public void SetUp()
        {
            ...
            _userInputService
                ...
                .Returns(Task.FromResult(_pickedPath));
        ...
        public void PickedFilePath_ValidPath_ResetsPathErrorMessageAndNavigatesToMetaDataView()
        {
            ...
            _serviceMock.Verify(
                (service) => service.IsValidFileSourcePath(It.Is<string>(p => p == _pickedPath)),
                Times.Once
            );
            
            _serviceMock.Verify(
                (service) => service.CreateFileSource(It.Is<string>(p => p == _pickedPath)),
                Times.Once
                );
